...
const _symbols = require('./symbols.js');

const _observers = _symbols._observers;
const _viewers = _symbols._viewers;
const _viewing = _symbols._viewing;
const _key = _symbols._key;
const _client = _symbols._client;
const _server_to_net = _symbols._server_to_net;
const _visible_tiles = _symbols._visible_tiles;
const _screen_set = _symbols._screen_set;
const _update_var = _symbols._update_var;
const _add_viewing = _symbols._add_viewing;
const _remove_viewing = _symbols._remove_viewing;
const _common_tiles_count = _symbols._common_tiles_count;
const _panel_map = _symbols._panel_map;
const _visgroups = _symbols._visgroups;
const _eye_to_eyeid = _symbols._eye_to_eyeid;
module.exports._symbols = _symbols;
