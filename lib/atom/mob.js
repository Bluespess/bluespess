...
module.exports._symbols = {_observers, _client, _viewers, _viewing, _server_to_net, _add_viewing, _remove_viewing, _update_var, _common_tiles_count};
		...
		Object.defineProperty(this, 'eyes', {enumerable: true,configurable: false, writable: false, value: new Proxy({}, {
			set: (target, property, value) => {
				...
				if(oldEye && this.client) {
					for(let netid in oldEye.components.Eye[_viewing]) {
				...
				if(value && this.client) {
					for(let netid in value.components.Eye[_viewing]) {
