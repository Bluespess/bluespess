...
const MobModule = require('./atom/mob.js');
const LightingModule = require('./atom/lighting.js');
const HearerModule = require('./atom/hearer.js');
...
class Bluespess extends EventEmitter {
	constructor() {
		...
		this.importModule(MobModule);
		this.importModule(LightingModule);
		this.importModule(HearerModule);
