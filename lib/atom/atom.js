...
class Atom extends EventEmitter {
	...
	set name(val) {this[_name] = val; this[mob_symbols._update_var]('name', 0);}
	...
	set screen_loc_x(val) {this[_screen_loc_x] = val; this[mob_symbols._update_var]('screen_loc_x', 0);}

	get screen_loc_y() {return this[_screen_loc_y];}
	set screen_loc_y(val) {this[_screen_loc_y] = val; this[mob_symbols._update_var]('screen_loc_y', 0);}
