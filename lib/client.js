	...
	set mob(val) {
		...
		if(this[_mob]) {
			...
			for(let eyeId in this[_mob].c.Mob.eyes) {
				...
				this.next_message.eye[eyeId] = {x:eye.x,y:eye.y,glide_size:eye.glide_size};
			}
		...
		if(this[_mob]) {
			...
			for(let eyeId in this[_mob].c.Mob.eyes) {
				...
				this.next_message.eye = this.next_message.eye || {};
				this.next_message.eye[eyeId] = {x:eye.base_mover.x,y:eye.base_mover.y,glide_size:eye.base_mover.glide_size};
			}
